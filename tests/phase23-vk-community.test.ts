...
describe("PHASE 23 VK community adapter", () => {
  ...
  it("collects wall comments and community DMs with independent cursors", async () => {
    ...
    expect(result.cursor).toBe("comments:1710000099|conversations:1|history:1|messages:11|otherwall:1|otherwallcomments:1|otherwallthreads:done|repostpages:1|suggestwall:1|wall:1|wallcomments:1|wallthreads:done");
