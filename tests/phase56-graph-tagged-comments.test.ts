...
describe("PHASE 56 Graph comments on tagged posts and media", () => {
  ...
  it("walks the next official Facebook tagged post comment after cursor and keeps older comments", async () => {
    ...
    expect(first.cursor).toBe(
      `comments:2026-08-21T12:00:00+0000|creplies:done|mentions:2026-08-21T12:00:00+0000|posts:done|ratings:done|ratingreplies:done|replies:done|tagged:done|taggedreplies:${encodeGraphReplies({ tag1: "tag-cmt-2" })}|threadmsgs:done|threads:done`,
    );
