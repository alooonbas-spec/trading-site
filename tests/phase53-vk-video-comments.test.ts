...
describe("PHASE 53 VK video.getComments", () => {
  ...
  it("walks the next official getComments offset window and keeps older video comments", async () => {
    ...
    expect(first.cursor).toBe(
      "mentionpages:1|photocomments:1|video:1710000200|videocomments:2|videos:done|wall:1|wallcomments:1|wallthreads:done",
    );
    expect(
  ...
  it("walks the next official video.get offset window and keeps older videos' comments", async () => {
    ...
    expect(result.cursor).toBe(
      "mentionpages:1|photocomments:1|video:1710000200|videocomments:1|videos:2|wall:1|wallcomments:1|wallthreads:done",
    );
  ...
  it("skips video offsets once videos:done and videocomments:done are stored", async () => {
    ...
    expect(result.cursor).toBe(
      "mentionpages:1|photocomments:1|video:1710000081|videocomments:done|videos:done|wall:1|wallcomments:1|wallthreads:done",
    );
