...
describe("PHASE 82 X retweets_of recent search", () => {
  ...
  it("walks the next official retweets_of pagination_token and keeps older retweets", async () => {
    ...
    expect(first.cursor).toBe(
      `dmpages:done|mentionpages:done|quotepages:done|replypages:done|retweetpages:${encodeXPageToken("rt-2")}|retweets:6001|tweetpages:done`,
    );
    ...
    expect(second.cursor).toBe(
      "dmpages:done|mentionpages:done|quotepages:done|replypages:done|retweetpages:done|retweets:6001|tweetpages:done",
    );
