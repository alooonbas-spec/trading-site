...
describe("PHASE 58 Graph Page ratings after paging", () => {
  ...
  it("walks the next official Facebook ratings after cursor and keeps older reviews", async () => {
    ...
    expect(first.cursor).toBe(
      `creplies:done|donethreads:done|otherthreads:done|pendingthreads:done|posts:done|ratingreplies:done|ratings:${encodeGraphAfter("rate-2")}|replies:done|reviews:2026-08-21T12:00:00+0000|spamthreads:done|tagged:done|taggedreplies:done|threadmsgs:done|threads:done`,
    );
    ...
    expect(second.cursor).toBe(
      "creplies:done|donethreads:done|otherthreads:done|pendingthreads:done|posts:done|ratingreplies:done|ratings:done|replies:done|reviews:2026-08-21T12:00:00+0000|spamthreads:done|tagged:done|taggedreplies:done|threadmsgs:done|threads:done",
    );
  ...
  it("skips Facebook ratings after paging once ratings:done is stored", async () => {
    ...
    expect(result.cursor).toBe(
      "creplies:done|donethreads:done|otherthreads:done|pendingthreads:done|posts:done|ratingreplies:done|ratings:done|replies:done|reviews:2026-08-21T09:00:00+0000|spamthreads:done|tagged:done|taggedreplies:done|threadmsgs:done|threads:done",
    );
  ...
  it("skips Facebook ratings without a story id, reviewer, or review text", async () => {
    ...
    expect(result.cursor).toBe(
      "creplies:done|donethreads:done|otherthreads:done|pendingthreads:done|posts:done|ratingreplies:done|ratings:done|replies:done|spamthreads:done|tagged:done|taggedreplies:done|threadmsgs:done|threads:done",
    );
  });
